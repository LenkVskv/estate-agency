...
function updateFlatsContent(){
  var flatsContainer = document.querySelector("#flats");
  var flatsContent = "";
  var localFlats = flats.slice(0);
  var flatType = document.querySelector("#flat_type").value;
  var flatPrice = document.querySelector("#price").value;
  var flatDistrict = document.querySelector("#district").value;
